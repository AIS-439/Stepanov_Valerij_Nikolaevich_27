...
[2.1 Понятие паттерна проектирования и назначение](#понятие-паттерна-проектирования-и-назначение)

[2.2 Классификация](#классификация)

[2.3 Принципы SOLID, связанные с темой (SRP, DIP)](#принципы-solid-связанные-с-темой-srp-dip)

[2.4 Слоистая архитектура и «границы приложения»](#слоистая-архитектура-и-границы-приложения)

[3 Паттерн Repository](#паттерн-repository)

[3.1 Определение и назначение паттерна](#определение-и-назначение-паттерна)

[3.2 Типовые обязанности репозитория](#типовые-обязанности-репозитория)

[3.3 Преимущества для разработки](#преимущества-для-разработки)

[3.4 Преимущества для администрирования и эксплуатации](#преимущества-для-администрирования-и-эксплуатации)

[3.5 Недостатки и типовые ошибки](#недостатки-и-типовые-ошибки)

[4 Service Layer](#service-layer)

[4.1 Определение и роль](#определение-и-роль)

[4.2 Границы ответственности](#границы-ответственности)

[4.3 Преимущества для разработки](#преимущества-для-разработки-1)

[4.4 Преимущества для администрирования](#преимущества-для-администрирования)

[4.5 Недостатки и антипаттерны](#недостатки-и-антипаттерны)

[5 DTO (Data Transfer Object)](#dto-data-transfer-object)

[5.1 Определение и назначение](#определение-и-назначение)

[5.2 DTO на границах](#dto-на-границах)

[5.3 Маппинг DTO и доменная модель (Mapper/Assembler)](#маппинг-dto-и-доменная-модель-mapperassembler)

[5.4 Преимущества для администрирования и эксплуатации](#преимущества-для-администрирования-и-эксплуатации-1)

[5.5 Риски DTO](#риски-dto)

[6 Совместное применение паттернов (FastAPI + SQLAlchemy)](#совместное-применение-паттернов-fastapi-sqlalchemy)

[6.1 Сквозной сценарий](#сквозной-сценарий)

[6.2 Поток: от Controller/API к выходной DTO](#поток-от-controllerapi-к-выходной-dto)

[6.3 Границы ответственности и критерии выбора](#границы-ответственности-и-критерии-выбора)
