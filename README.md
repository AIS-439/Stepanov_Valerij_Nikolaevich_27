...
[2 Теоретические основы и контекст [5](#теоретические-основы-и-контекст)](#теоретические-основы-и-контекст)

[2.1 Понятие паттерна проектирования и назначение [5](#понятие-паттерна-проектирования-и-назначение)](#понятие-паттерна-проектирования-и-назначение)

[2.2 Классификация [5](#классификация)](#классификация)

[2.3 Принципы SOLID, связанные с темой (SRP, DIP) [6](#принципы-solid-связанные-с-темой-srp-dip)](#принципы-solid-связанные-с-темой-srp-dip)

[2.4 Слоистая архитектура и «границы приложения» [6](#слоистая-архитектура-и-границы-приложения)](#слоистая-архитектура-и-границы-приложения)

[3 Паттерн Repository [8](#паттерн-repository)](#паттерн-repository)

[3.1 Определение и назначение паттерна [8](#определение-и-назначение-паттерна)](#определение-и-назначение-паттерна)

[3.2 Типовые обязанности репозитория [8](#типовые-обязанности-репозитория)](#типовые-обязанности-репозитория)

[3.3 Преимущества для разработки [8](#преимущества-для-разработки)](#преимущества-для-разработки)

[3.4 Преимущества для администрирования и эксплуатации [9](#преимущества-для-администрирования-и-эксплуатации)](#преимущества-для-администрирования-и-эксплуатации)

[3.5 Недостатки и типовые ошибки [9](#недостатки-и-типовые-ошибки)](#недостатки-и-типовые-ошибки)

[4 Service Layer [12](#service-layer)](#service-layer)

[4.1 Определение и роль [12](#определение-и-роль)](#определение-и-роль)

[4.2 Границы ответственности [12](#границы-ответственности)](#границы-ответственности)

[4.3 Преимущества для разработки [12](#преимущества-для-разработки-1)](#преимущества-для-разработки-1)

[4.4 Преимущества для администрирования [13](#преимущества-для-администрирования)](#преимущества-для-администрирования)

[4.5 Недостатки и антипаттерны [13](#недостатки-и-антипаттерны)](#недостатки-и-антипаттерны)

[5 DTO (Data Transfer Object) [15](#dto-data-transfer-object)](#dto-data-transfer-object)

[5.1 Определение и назначение [15](#определение-и-назначение)](#определение-и-назначение)

[5.2 DTO на границах [15](#dto-на-границах)](#dto-на-границах)

[5.3 Маппинг DTO и доменная модель (Mapper/Assembler) [15](#маппинг-dto-и-доменная-модель-mapperassembler)](#маппинг-dto-и-доменная-модель-mapperassembler)

[5.4 Преимущества для администрирования и эксплуатации [16](#преимущества-для-администрирования-и-эксплуатации-1)](#преимущества-для-администрирования-и-эксплуатации-1)

[5.5 Риски DTO [17](#риски-dto)](#риски-dto)

[6 Совместное применение паттернов (FastAPI + SQLAlchemy) [19](#совместное-применение-паттернов-fastapi-sqlalchemy)](#совместное-применение-паттернов-fastapi-sqlalchemy)

[6.1 Сквозной сценарий [19](#сквозной-сценарий)](#сквозной-сценарий)

[6.2 Поток: от Controller/API к выходной DTO [19](#поток-от-controllerapi-к-выходной-dto)](#поток-от-controllerapi-к-выходной-dto)

[6.3 Границы ответственности и критерии выбора [22](#границы-ответственности-и-критерии-выбора)](#границы-ответственности-и-критерии-выбора)

[7 Заключение [24](#заключение)](#заключение)

[8 Список литературы [26](#список-литературы)](#список-литературы)
