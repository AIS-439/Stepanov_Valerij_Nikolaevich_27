...
1. [Введение](#введение)
2. [Теоретические основы и контекст](#теоретические-основы-и-контекст)
   - [Понятие паттерна проектирования и назначение](#понятие-паттерна-проектирования-и-назначение)
   - [Классификация](#классификация)
   - [Принципы SOLID, связанные с темой (SRP, DIP)](#принципы-solid-связанные-с-темой-srp-dip)
   - [Слоистая архитектура и «границы приложения»](#слоистая-архитектура-и-границы-приложения)
3. [Паттерн Repository](#паттерн-repository)
   - [Определение и назначение паттерна](#определение-и-назначение-паттерна)
   - [Типовые обязанности репозитория](#типовые-обязанности-репозитория)
   - [Преимущества для разработки](#преимущества-для-разработки)
   - [Преимущества для администрирования и эксплуатации](#преимущества-для-администрирования-и-эксплуатации)
   - [Недостатки и типовые ошибки](#недостатки-и-типовые-ошибки)
4. [Service Layer](#service-layer)
   - [Определение и роль](#определение-и-роль)
   - [Границы ответственности](#границы-ответственности)
   - [Преимущества для разработки](#преимущества-для-разработки-1)
   - [Преимущества для администрирования](#преимущества-для-администрирования)
   - [Недостатки и антипаттерны](#недостатки-и-антипаттерны)
5. [DTO (Data Transfer Object)](#dto-data-transfer-object)
   - [Определение и назначение](#определение-и-назначение)
   - [DTO на границах](#dto-на-границах)
   - [Маппинг DTO и доменная модель (Mapper/Assembler)](#маппинг-dto-и-доменная-модель-mapperassembler)
   - [Преимущества для администрирования и эксплуатации](#преимущества-для-администрирования-и-эксплуатации-1)
   - [Риски DTO](#риски-dto)
6. [Совместное применение паттернов (FastAPI + SQLAlchemy)](#совместное-применение-паттернов-fastapi--sqlalchemy)
   - [Сквозной сценарий](#сквозной-сценарий)
   - [Поток: от Controller/API к выходной DTO](#поток-от-controllerapi-к-выходной-dto)
   - [Границы ответственности и критерии выбора](#границы-ответственности-и-критерии-выбора)
...
## Теоретические основы и контекст

### Понятие паттерна проектирования и назначение
...
### Принципы SOLID, связанные с темой (SRP, DIP)
...
### Слоистая архитектура и «границы приложения»
...
### Определение и назначение паттерна
...
Его назначение — отделить бизнес‑логику и прикладные сценарии от инфраструктурных деталей (таблиц, запросов, драйверов), чтобы у каждого слоя была более чёткая ответственность и ниже связанность.

### Типовые обязанности репозитория
...
### Преимущества для администрирования и эксплуатации
...
Сервисный слой отвечает за оркестрацию use-case: какие шаги выполнить, в каком порядке, какие зависимости задействовать и какой результат вернуть наружу. Также он часто становится местом управления сквозными аспектами выполнения сценариев — например, транзакционными границами и согласованностью вызовов нескольких репозиториев в рамках одной операции. 

Дополнительно на уровне Service Layer удобно централизовать политики доступа, валидацию входных данных (на уровне сценария) и интеграции с внешними системами (очереди, почта, сторонние API), оставляя доменной модели чистые бизнес‑правила.
...
### Преимущества для администрирования
...
## Совместное применение паттернов (FastAPI + SQLAlchemy)
...
### Поток: от Controller/API к выходной DTO
...
### Границы ответственности и критерии выбора
